...
import siestageek.annotation.HelloSpring5Bean07;
...
public class HelloSpring5App07 {
    ...
    public static void main(String[] args) {
        ...
        HelloSpring5Bean07 bean = null;

        bean = (HelloSpring5Bean07) ctx.getBean("kor");
        bean.sayHello("스프링 5");

        bean = (HelloSpring5Bean07) ctx.getBean("eng");
        bean.sayHello("Spring 5");

        bean = (HelloSpring5Bean07) ctx.getBean("jpn");
